//Component Controller to get Picklist Values & FLS & Default Values.
...
({
    doInit: function(component, event, helper) {
        ...
        helper.fetchPickListVal(component, 'Stop_Loss__c', 'BRFStopLoss');
        helper.fetchPickListVal(component, 'Specific_Stop_Loss_Options__c', 'BRFSpecificStopLossOption');
        helper.fetchPickListVal(component, 'Aggregate_Stop_Loss_Options__c', 'BRFAggregateStopLoss');
        helper.fetchPickListVal(component, 'Stop_Loss_Contract_Period__c', 'BRFStopLossContractPeriod');
        ...
        helper.getfieldValue(component,'v.BRFStopLossDisabled','Stop_Loss__c');
        helper.getfieldValue(component,'v.NPStopLossDisabled','Non_Preferred_Stop_Loss_Carrier__c');
        helper.getfieldValue(component,'v.BRFSpecificStopLossOptionDisabled','Specific_Stop_Loss_Options__c');
        helper.getfieldValue(component,'v.BRFAggregateStopLossDisabled','Aggregate_Stop_Loss_Options__c');
        helper.getfieldValue(component,'v.BRFStopLossContractPeriodDisabled','Stop_Loss_Contract_Period__c');
	...
	//Save BRF when user clicks on Save Button.    
