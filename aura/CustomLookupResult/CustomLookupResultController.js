({    
	...
	var fullName = '';
        ...
        if (typeSObject != null && typeSObject !='' && typeSObject.toLowerCase() == 'case') {
            fullName = component.get("v.lookUpItem.CaseNumber");
            matchPart = component.get("v.matchString");
        } else if (typeSObject != null && typeSObject !='' && typeSObject.toLowerCase() == 'contract') {
            fullName = component.get("v.lookUpItem.ContractNumber");
            matchPart = component.get("v.matchString");
        } else if (typeSObject != null && typeSObject !='' && typeSObject.toLowerCase() == 'order') {
            fullName = component.get("v.lookUpItem.OrderNumber");
            matchPart = component.get("v.matchString");
        } else if (typeSObject != null && typeSObject !='' && typeSObject.toLowerCase() == 'orderitem') {
        ...
        if (typeSObject != null && typeSObject !='' &&  (typeSObject.toLowerCase() == 'contact' || typeSObject.toLowerCase() == 'order' || typeSObject.toLowerCase() == 'contract') && component.get("v.lookUpItem.Account.Name") != null && component.get("v.lookUpItem.Account.Name") != '')
            component.set("v.additionalInfo", component.get("v.lookUpItem.Account.Name"));
        
        if (typeSObject != null && typeSObject !='' && typeSObject.toLowerCase() == 'lead' && component.get("v.lookUpItem.Title") != null && component.get("v.lookUpItem.Title") != '')
            component.set("v.additionalInfo", component.get("v.lookUpItem.Title"));
        
        if (typeSObject != null && typeSObject !='' && typeSObject.toLowerCase() == 'case' && component.get("v.lookUpItem.Subject") != null && component.get("v.lookUpItem.Subject") != '')
            component.set("v.additionalInfo", component.get("v.lookUpItem.Subject"));
        
        if (typeSObject != null && typeSObject !='' && typeSObject.toLowerCase() == 'product2' && component.get("v.lookUpItem.ProductCode") != null && component.get("v.lookUpItem.ProductCode") != '')
            component.set("v.additionalInfo", component.get("v.lookUpItem.ProductCode"));
        if (typeSObject != null && typeSObject !='' && typeSObject.toLowerCase() == 'Opportunity' && component.get("v.lookUpItem.Opportunity") != null && component.get("v.lookUpItem.Opportunity") != '')
        {} // component.set("v.additionalInfo", component.get("v.lookUpItem.Opportunity"));
       ...
       console.log(fullName);
        if (fullName) {
			...
			lowerCaseAdditionalInfo = additionalInfo.toLowerCase();            
              ...
              console.log('lowerCaseAdditionalInfo=='+lowerCaseAdditionalInfo);
