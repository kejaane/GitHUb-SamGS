({
    searchHelper : function(component,event,getInputkeyWord) {
        ...
        if (getInputkeyWord.length < 3 &&  type != null &&  type != '' && type.toLowerCase() != 'contact') {
            ...
            action.setParams({
                ...
                'ParentAccId'	: component.get("v.ParentAccId")
            });
    ...
    showRecentViewesHlp : function(component, event, helper) {
        ...
        if (isShows && sObjectType != null && sObjectType != '' && sObjectType.toLowerCase() != 'orderitem') {
