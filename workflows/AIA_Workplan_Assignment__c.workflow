<?xml version="1.0" encoding="utf-8"?><Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>Set_Assigned_Date_to_now</fullName>
        <field>Assigned_Date_Time__c</field>
        <formula>NOW()</formula>
        <name>Set Assigned Date to now</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Set_Date_Accepted_to_blank</fullName>
        <field>Date_Accepted__c</field>
        <name>Set Date Accepted to blank</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Null</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Set_Date_Completed_to_blank</fullName>
        <field>Date_Completed__c</field>
        <name>Set Date Completed to blank</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Null</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>/*AND(TEXT(Status__c) == 'Sent', Workplan_Type_Task__r.Send_Notification__c, ISBLANK(Proposal_Request_Form__c))
*/

/* Updated by SD - 07/01/2016 */
AND(TEXT(Status__c) = 'Sent',
Send_Notification__c, 
ISBLANK(Proposal_Request_Form__c))</formula>
    ...
    <rules>
        ...
        <criteriaItems>
            ...
            <value>Accepted,In Progress</value>
        </criteriaItems>
    ...
    <rules>
        <fullName>AIA Workplan Assignment Reassignment</fullName>
        <actions>
            <name>Set_Assigned_Date_to_now</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Set_Date_Accepted_to_blank</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Set_Date_Completed_to_blank</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
        ...
        <active>true</active>
        <description>Reset Workplan Assignment Fields When New Assignee Is Selected</description>
        <formula>OR(ISCHANGED(OwnerId),ISCHANGED( External_Assignee__c ))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <formula>AND((NOT(ISBLANK(Proposal_Request_Form__c))),(NOT(ISBLANK(External_Assignee__c))))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
